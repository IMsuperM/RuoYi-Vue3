 ...
 * needDictionary  需要查询字典的 字段; "filterable"- 是否需要字典下拉项 可搜索匹配; "multipleSelcet"--是否需要字典下拉项 可多选;
...
export function getStatisticsCellData() {
    return [
        ...
        { charLength: 8, type: 'normal', val: '', label: '放款成功订单数', prop: 'loanSuccessNum', show: true },
